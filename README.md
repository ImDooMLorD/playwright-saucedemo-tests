...
My Playwright E2E test automation project for SauceDemo using the Page Object Model design pattern.
...
```bash
git clone https://github.com/doomlord/playwright-saucedemo-tests.git
```
